...
strat.init = function() {
    this.ichimoku = new Ichimoku({
        conversionPeriod : 9,  //this.settings.conversionPeriod,
        basePeriod       : 26, //this.settings.basePeriod,
        spanPeriod       : 52, //this.settings.spanPeriod,
        displacement     : 26, //this.settings.displacement,
        values           : []
    });
...
strat.update = function(candle) {
    ...
    console.log(updateIchimokuValue);
